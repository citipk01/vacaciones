...
function OnSelVac(){
	...
	var dias_totales=parseInt(diasArr + diasCal);
	bxF('dias_totales').Value(dias_totales);

	var diasRestantes
	diasRestantes = dias_totales - parseInt(bxF('dias_tomados').Value());


	bxF('dias_restantes').Value(diasRestantes);
